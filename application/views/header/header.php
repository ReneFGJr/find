...
<head>
  ...
  <link rel="stylesheet" href="<?php echo base_url('css/style.css?version=0.21.01C');?>">
  ...
  <script type="text/javascript" src="<?php echo base_url('js/bootstrap.js');?>"></script>  <script type="text/javascript" src="<?php echo base_url('js/jquery.mask.js');?>"></script>
