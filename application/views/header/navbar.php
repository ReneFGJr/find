...
<nav class="navbar navbar-toggleable-md navbar-light bg-faded">
	...
	<a class="navbar-brand" href="<?php echo base_url(PATH); ?>"><img src="<?php echo base_url('img/logo_library.png');?>" style="height: 30px;"></a>
		...
		<ul class="navbar-nav mr-auto">
			...
			<li class="nav-item dropdown">
				...
				<div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
				    ...
				    <a class="dropdown-item" href="<?php echo base_url(PATH.'mod/loans/users'); ?>"><?php echo msg('loan_users');?></a>
            ...
            { ?>
            <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle" href="<?php echo base_url(PATH.'config'); ?>" id="navbarDropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><?php echo msg('menu_config');?></a>
                <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
