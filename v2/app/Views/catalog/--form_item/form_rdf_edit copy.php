...
<div class="card-header bg-primary text-white">
    <i class="bi bi-pencil-square me-2"></i> Edição QQ de Metadados RDF
</div>
                            ...
                            case 'CONCEPT': ?>
                                <nobr>
                                    <?php if ($prop != $w['c_class']): ?>
                                        <button type="button" class="btn btn-outline-success btn-sm btn-adicionar-atributo"
...
<script>
    document.querySelectorAll('.btn-adicionar-atributo').forEach(function(btn) {
        btn.addEventListener('click', function() {
            ...
            var iframe = document.getElementById('iframeAdicionarConceito');
            iframe.src = '/catalog/rdf/concept_add?' + params.toString();
            var offcanvas = bootstrap.Offcanvas.getOrCreateInstance(document.getElementById('offcanvasAdicionarConceitoIframe'));
            offcanvas.show();
        });
    });
</script>
